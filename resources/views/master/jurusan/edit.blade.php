        ...
        <div class="row">
            <div class="col-md-4">
                    ...
                    <div class="input-group @error('kd_jurusan') has-error @enderror">
                        ...
                        <input type="text" class="form-control" autocomplete="off" name="kd_jurusan" value="{{$jurusan->kd_jurusan}}">
                        @error('kd_jurusan')
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-group @error('nama_jurusan') has-error @enderror">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" autocomplete="off" name="nama_jurusan" value="{{$jurusan->nama_jurusan}}" placeholder="Nama Lengkap">
                        @error('nama_jurusan')
                        <div class="invalid-feedback text-danger">
                            {{ $message }}
                        </div>
